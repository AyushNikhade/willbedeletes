...
function Login({user, setUser}) {
    ...
    const handleSubmit = async (e) => {
        ...
        const {data} = await axios.post("http://localhost:4000/api/v1/user/login", { email: emailOrPhone, password }, config)
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    {/* Phone/Email Field */}
                    <div className="mb-4">
                        <label className="block text-gray-700 font-semibold mb-2" htmlFor="emailOrPhone">
                            Phone or Email
                        </label>
                        <input
                            type="text"
                            ...
                            value={emailOrPhone} // Bind state to input value
