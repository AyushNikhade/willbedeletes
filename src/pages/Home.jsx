...
const HomePage = () => {
  ...
  const handleReportSubmission = () => {
    // Here you can also perform any operations before navigating, e.g., form validation or API calls.
    alert('Start Report Submission');
    navigate('/abuse-report'); // Navigate to the AbuseReportForm component
};
